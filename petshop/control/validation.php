...
$flag=0;  
$json = file_get_contents("../model/admin.json");
...
if (preg_match('[@_!#$%^&*()<>?/|}{]', $_POST["aid"])!=0)
	{
$flag=1;
echo "<br> span style='color:red;'><small>Name Required</small></span>";
}
...
$flag=1;
echo "<br><span style='color:red;'>Password length should be more than 4";
...
if($flag==0){
       ...
       $existingdata = file_get_contents("../model/admin.json");
       $tempJSONdata = json_decode($existingdata);
       $tempJSONdata[] =$formdata;
       //Convert updated array to JSON
	   $jsondata = json_encode($tempJSONdata);	   
	   //write json data into data.json file
	   if(file_put_contents("../model/admin.json", $jsondata)) {
